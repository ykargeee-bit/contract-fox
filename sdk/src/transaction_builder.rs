...
pub fn build_donate_transaction(
    ...
    let operations = build_donate_operations(donor_pubkey, campaign_id, token_id_bytes, amount, memo, contract_id_bytes)
        .map_err(|e| StellarAidError::ValidationError(e))?;
...
fn build_donate_operations(
    ...
    let donate_op = build_donate_operation(donor_address, campaign_id, token_id_bytes, amount, memo, contract_id_bytes);
    Ok(vec![donate_op])
}
